...
**We invite you to honor these principles:**

---

## 1. Non-Extractive Use
...
If you're applying CD in high-stakes contexts, ask: "Would I want this system applied to me or someone I care about, knowing what I know about its limitations?"

---

## 2. Intellectual Honesty

CD distinguishes between what is **proved** (existence theorems, spectral results), what is **modeled** (canonical closures, coefficient choices), and what is **interpreted** (connections to enactivism, semiotics, phenomenology).
...
The Creative Determinant is a **research seed**, not a finished theory. It will grow through:
- Theoretical extensions (new theorems, alternative closures, tighter bounds)
- Empirical tests (CD condition measurements, falsification experiments)
...
CD emerged from a background in behavioral health and a commitment to AI safety as a humanitarian concern.

If your use of CD generates substantial commercial value, consider:
- Supporting humanitarian causes (mental health access, AI safety research, education)
- Making your CD-based tools accessible to underserved communities where feasible
- Sharing knowledge openly where it doesn't compromise legitimate business interests

This is an invitation, not a requirement. But it honors the origin of this work.
...
- **IP indemnity** (protection against patent claims)
- **Custom extensions** (specialized CD variants for your use case)

Contact: nelson@projectnavi.ai

We offer commercial services under separate agreements (using our standard PNEUL-D dual-license structure). But such agreements are **not required** to use the Creative Determinant framework under Apache 2.0.
...
This covenant reflects that philosophy: ethical behavior is not imposed through rigid rules, but emerges through:
- **Care** (attention to impact and responsibility)
- **Coherence** (integration of values and actions)
- **Managed contradiction** (honest acknowledgment of tensions and trade-offs)
- **Viability** (sustainable practices that can be maintained over time)

We invite you to help build a research community that embodies these principles.
