...
Then I found myself in the strange position of teaching myself AI alignment from scratch. No computer science degree. No formal math background. Just a deep, unshakable conviction that the field was asking the wrong questions.

We kept asking: *"Is this output safe?"*
...
## Why I'm Publishing Despite Doubt
...
## To the Person Reading This Who Also Feels Unqualified
...
This specification is the result of nine months of:

- Learning mathematics I didn't know I needed.
- Reading across cognitive science, philosophy, physics, and AI.
- Asking people smarter than me in each domain to poke holes.
- Writing code to verify that the theory actually *does* produce the bifurcations and thresholds it claims.
- Sitting with the gaps and refusing to hide them.

It is imperfect. It will evolve. But it is honest.

Every equation here is an attempt to translate what I already knew in practice (from years of watching change) into language the field can verify and extend. Every test is a way to hold myself and this framework accountable to what we say we value.
...
To everyone who asked hard questions while I was building this. To the people in behavioral health who taught me what change actually looks like. To the AI safety researchers who convinced me that alignment is the most important problem. To the mathematicians who didn't laugh when I asked basic questions. To my family for letting me disappear into this for nine months.

And to you, reading this: thank you for taking it seriously enough to consider whether it might be right, or rigorously enough to consider where it might be wrong.
...
One last thing: the fact that I'm not formally qualified should not make this work *less* credible on the merits, and should not make it *more* credible on the merits either.

Check the math. Run the code. Test the predictions. Ignore my background, my story, my conviction. **Judge the framework on what it actually claims and whether those claims hold up.**
